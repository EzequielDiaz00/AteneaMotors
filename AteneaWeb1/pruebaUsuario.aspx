<%@ Page Title="" Language="C#" MasterPageFile="~/Master3.Master" AutoEventWireup="true" CodeBehind="pruebaUsuario.aspx.cs" Inherits="AteneaWeb1.pruebaUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="form-group">
            <label for="txtAuto">Modelo vehiculo</label>
            <asp:TextBox ID="txtAuto" runat="server" CssClass="form-control" Width="360px"></asp:TextBox>
        </div>

        <div class="form-group">
            <label for="txtFecha">Fecha</label>
            <asp:TextBox ID="txtFechaP" runat="server" CssClass="form-control" Width="430px"></asp:TextBox>
            <br />
            <br />
            <asp:Calendar Style="margin-left:auto;margin-right:auto;" ID="calFechaP" runat="server" OnSelectionChanged="calFechaP_SelectionChanged"></asp:Calendar>
        </div>
        <br />
